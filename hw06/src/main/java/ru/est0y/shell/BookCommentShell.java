...
public class BookCommentShell {
    ...
    public String displayById(@ShellOption(value = "id") long id) {
    ...
    public void insertComment(@ShellOption(value = "text") String text, @ShellOption(value = "bookId") long bookId) {
        bookCommentService.insert(text, bookId);
    }

    @ShellMethod(key = {"uc", "update-comment"}, value = "update comment")
    public void updateComment(@ShellOption(value = "id") long id, @ShellOption(value = "text") String text) {
